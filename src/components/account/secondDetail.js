...
import { Table, Pagination, Select, DatePicker, Button, Input, Icon, Spin, Row, Col, message, Modal, Radio, InputNumber } from 'antd';
...
export default class firstPartner extends React.Component {
    ...
    onSelectChange = (selectedRowKeys, selectedRows) => {
        ...
        this.setState({
            ...
            console.log(this.state.batchList);
        });
    }
            ...
            <div className="g-library">
                ...
                <div className="m-library-bd">
                    <Row className="m-select">
                        ...
                        {/*<Select defaultValue="BOOK_NAME" style={{ width: 170 }}>*/}
                        {/*<Option value={null}>全部</Option>*/}
                        {/*<Option value="BOOK_CODE">幼儿园名称</Option>*/}
                        {/*<Option value="BOOK_NAME">设备SN码</Option>*/}
                        {/*</Select>*/}
                        {/*</div>*/}
                        <div className="m-inSel">
