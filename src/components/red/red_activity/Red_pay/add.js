 ...
 checkPrice = (rule, value, callback) => {
  ...
  //////////////样式/////////////////// 
    ...
    console.log(this.state.redList)
      ...
      <h2 style={title}><Link style={font_color} to="/red/redpay" ><Icon style={back} type="left" />添加充值送红包</Link></h2>
        <div style={box}>
                ...
                <Col span={8}>
                  {
                    getFieldDecorator('a', {
                      rules: [
                        { required: true, message:this.state.btn2?'' : text_prompt,validator:this.checkPrice},
                        ],
                    })(<InputNumber onChange={(value)=>{this.changeInputabc("input_a",value)}}/>)
                  }
                </Col>
                <Col span={8} offset={4}>
                    <Input value={this.state.input_a?this.state.input_a+"咿啦币":null} disabled></Input>
                </Col>
              </Row>
            </FormItem>
                ...
                <Col span={8}>
                  {
                    ...
                    })(<Input onChange={(value)=>{this.changeInputabc("input_b",value)}}/>)
                  }
                </Col>
                <Col span={8} offset={4}>
                    <Input value={this.state.input_b?this.state.input_b+"人民币":null} disabled></Input>
                </Col>
              </Row>
            </FormItem>
                ...
                <Col span={8}>
                  {
                    ...
                    })(<InputNumber onChange={(value)=>{this.changeInputabc("input_c",value)}}/>)
                  }
                </Col>
                <Col span={8} offset={4}>
                    <Input value={this.state.input_c?"送"+this.state.input_c+"元红包":null} disabled></Input>
                </Col>
              </Row>
            </FormItem>
