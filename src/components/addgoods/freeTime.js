...
export default class PriceSet extends React.Component {
    ...
    add() {
        ...
        var flag=true;
        this.state.curData.forEach((item)=>{
            ...
            if(item.limitType==this.state.tempData.limitType){
                        ...
                        <span
                            ...
                            onClick={() => {
                                ...
                                this.setState({
                                    ...
                                    curData:this.state.freeTimeData.filter((item,Index)=>index!=Index),
                                    idx: index
                                },()=>{
                                    console.log(this.state)
                                })
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            this.setState({
                                visible: true,
                                isAdd: true,
                                curData:this.state.freeTimeData
                            })
                        }}
                        type="primary"
                    >添加限定</Button>
