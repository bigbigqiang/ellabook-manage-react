...
import GoodsSet from '../addellagold/GoodsSet.js';
import ContentSet from "../addellagold/ContentSet.js";
import PriceSet from "../addellagold/PriceSet.js";
import GoodsState from "../addellagold/GoodsState.js";
...
export default class addGoods extends React.Component {
	...
	render(){
		...
		return <div>
			<h2 className="addGoodsTitle"><Link to="/goodsList"><Icon type="left" />{" "}增加咿啦币</Link></h2>
			<div className="box">
