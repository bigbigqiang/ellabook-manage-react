			...
			columns : [
				{
				  ...
				  width:400,
				  render : (text,record) => (
				  	<Select defaultValue="请选择咿啦币" style={{ width: 120 }} onChange={(value)=>{this.handleChange(value)}}>
    				  {
	...
	async fetchResultItem(){
		var data = await fetch(getUrl.url,{
			mode : "cors",
      		...
      		body:"method=ella.operation.thirdSearchList"+"&content="+JSON.stringify({"text":"","searchType":"searchCoin"})+dataString
		}).then(res => res.json());
		console.log(data);
		this.setState({
