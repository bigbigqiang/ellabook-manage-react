...
import AddRemark from "./addRemark.js"
...
export default class CommentAll extends React.Component {
	constructor(props) {
		super(props)
		this.state = {
			loading: true,
			...
			<div className="commentAll">
				<Spin spinning={this.state.loading} size="large">
					...
					<div className="g-comSerchTiy">
						...
						<Search placeholder="输入检索内容" enterButton className="searchWidth intervalRight" onSearch={(value) => { this.searchContent("searchText", value) }} />
					...
					<Modal
						...
						width={700}
					>
						{thisTrue.state.visible && <AddRemark handleCancel={() => this.handleCancel()}></AddRemark>}
					</Modal>
				</Spin>
			</div>
		);
