...
class addSign extends React.Component {
    ...
    changeBook(value,index){
        console.log(value);
        this.setState({
            rewardBookList:this.state.rewardBookList.map((item,_index)=>{return index==_index ? {giftName:value,prizeCategory:'BOOK',bookCode:value} : item})
        })
    }
    delBook(index){
        console.log(index);
    ...
    changeVip(value,index){
        console.log(value);
        this.setState({
            rewardBookList:this.state.rewardBookList.map((item,_index)=>{return index==_index ? {giftName:value,prizeCategory:'VIP'} : item})
        })
    }
    delVip(index){
        console.log(index);
    ...
    changeRedPrice(value,index){
        console.log(value);
        this.setState({
            rewardBookList:this.state.rewardBookList.map((item,_index)=>{return index==_index ?  {giftName:value,prizeCategory:'COUPON'} : item})
        })
    }
    delRed(index){
        console.log(index);
    ...
    save(){        
        this.setState({
            activityPrizeList:this.state.rewardBookList.concat(this.state.rewardVipList.concat(this.state.rewardRedList))
        },()=>{
                ...
                <div className="m-addSign-bd">
                    <Spin tip="加载中..." spinning={this.state.loading} size="large" style={{zIndex:9999}}>
                        <Row className="m-input">
                            ...
                            <Col span={5}>
                                {
                                    <Input style={{ width: 260 }} onChange={(e) => this.activityNameChange(e.target.value)} />
                                }
                            </Col>
                        </Row>
                        <Row className="m-input">
                        <Col span={2} style={{ width: 170,textAlign:'right' }}><span className="u-txt">签到天数</span></Col>
                            <Col span={3}>
                                <Select defaultValue="7" style={{ width: 170 }} onChange={(value)=>this.signDayChange(value)}>
                        ...
                        <Row className="m-input">
                            ...
                            <Col span={3}>
                                ...
                                <DatePicker
                                    ...
                                    onOk={onOk}
                                    // value={this.state.startTime==null?'':moment(this.state.startTime,'YYYY-MM-DD hh:mm:ss')}
                                />
                            </Col>
                            ...
                            <Col span={3}>
                                <DatePicker
                                    ...
                                    onOk={onOk}
                                    // value={this.state.endTime==null?'':moment(this.state.endTime,'YYYY-MM-DD hh:mm:ss')}
                                />
                            </Col>
                        </Row>
                        <Row className="m-input">
