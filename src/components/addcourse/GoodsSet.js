...
export default class GoodsSet extends React.Component {
	constructor({getGoodsSetData,goodsSetData}){
		super()
		this.state={
			goodsName  : "",//商品名字
      goodsType  : "内容",//商品类型
    ...
    getGoodsSetData("goodsType","ELLA_COURSE");	
      ...
      <div>
        ...
        <div className="goodsSet">
          <Row className="row">
            ...
            <Col className="goodsSetTitle" span={6}>{this.props.goodsSetData.goodsCode!=0?this.props.goodsSetData.goodsCode:"未知"}</Col>
          </Row>
          <Row>
            <Col className="goodsSetTitle" span={2}>商品类型:</Col>
            <Col className="goodsSetTitle" span={6}>课程</Col>
            <Col className="goodsSetTitle" span={2}>商品名称:</Col>
            <Col span={4}>
              <Input 
              defaultValue={this.props.goodsSetData.goodsName==0?"":this.props.goodsSetData.goodsName}
